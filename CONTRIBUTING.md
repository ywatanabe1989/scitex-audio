# Contributing to SciTeX Audio

Thank you for your interest in contributing to SciTeX Audio. This guide covers the
...
- Search [existing issues](https://github.com/ywatanabe1989/scitex-audio/issues)
  before opening a new one.
- Include a minimal reproducible example when reporting bugs.
- Specify your Python version, OS, and `scitex-audio` version.

## Development Setup

```bash
git clone git@github.com:ywatanabe1989/scitex-audio.git
cd scitex-audio
pip install -e ".[dev]"
```
